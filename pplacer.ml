 ...
 *
 * TODO: move the prior calculation inside
*)
  ...
  if not !Sys.interactive then begin
    ...
    *)
    ...
    | Some rp ->
        ...
        let mrca_locs = Tax_gtree.mrca_list t in
        let ps = Mutpick.get_picks model t ~darr ~parr mrca_locs in
        List.iter Ppr.print_int_array ps;
    | None -> ();
