# -*- coding: utf-8 -*-
#
# pplacer documentation build configuration file, created by
...
project = u'pplacer'
copyright = u'2011-2013, Erick Matsen and Aaron Gallagher'
...
def get_version(default=version):
    """
    parse version
    """
...
exclude_patterns = ['_build','details']
